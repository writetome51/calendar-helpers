import {GetDaysOfMonthService as getDaysOfMonth}
	from './get-days-of-month_service/get-days-of-month.service.js';
import {GetMonthIncrementedOrDecrementedService as getMonthIncrementedOrDecremented}
	from './get-month-incremented-or-decremented.service.js';
import {StartYearData} from './start-year.data.js';
...
export class MonthDataCalculatorService {
	...
	static getNextOrPreviousMonthData(plusOrMinusOne) {
		const {
			monthIndex,
			year
		} = getMonthIncrementedOrDecremented.go(plusOrMinusOne, {
			monthIndex: this.__monthIndex,
			year: this.__year
		});
