import {getAsWeekdayIndex} from './get-as-weekday-index.function.js';
import {GetNumLeapYearsPassedService as getNumLeapYearsPassed}
	from './get-num-leap-years-passed.service.js';
import {getHead} from '@writetome51/array-get-head-tail';
import {getSum} from '@writetome51/get-sum-average-product';
import {StartYearData as startYear} from '../../start-year.data.js';
import {yearValid} from './year-valid.function.js';
