export class GetMonthIncrementedOrDecrementedService {
    static go(plusOrMinusOne, { monthIndex, year }) {
        let data = this.__getMonthIndexAndYearPreparedIfEnteringNextOrPreviousYear(plusOrMinusOne, monthIndex, year);
        data.monthIndex += plusOrMinusOne;
        return data;
    }
    static __getMonthIndexAndYearPreparedIfEnteringNextOrPreviousYear(plusOrMinusOne, monthIndex, year) {
